...
export default function MembersPageClient() {
  ...
  return (
    <div className="flex flex-col flex-1 overflow-auto w-full"> <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 px-4 py-4 md:px-6"> <div> <h2 className="text-2xl font-bold tracking-tight">Member Registry</h2> <p className="text-sm text-muted-foreground mt-1">
      {totalMembers} {totalMembers === 1 ? "member" : "members"} in this group </p> </div>
